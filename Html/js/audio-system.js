/* =============================================================
   ...
   =============================================================
   Place music at: music/song1.mp3, song2.mp3, etc.
...
const playlist = [
  {
    ...
    title:     'Асылым',
    artist:    'V $ X V PRiNC',
    file:      'music/v--x-v-prince-asilim-(allmusic.kz).mp3',
    cover:     'js/jpg/Abirok1.jpeg',
    startTime: 0,
    endTime:   null,
    loopStart: null,
    volume:    0.8,
  ...
  },
  {
    ...
    title:     'KETPE',
    artist:    'Dasdinlovee',
    file:      'music/Dasdinlovee - KETPE (kazmuz.kz).mp3',
    cover:     'js/jpg/Abirok2.jpeg', 
  ...
  },
  {
    ...
    title:     'Mahabbatym',
    artist:    'baqzhvn',
    file:      'music/baqzhvn – Махаббатым (Qazaq Edition).mp3',
    cover:     'js/jpg/Abirok2.jpeg',
    startTime: 0,
    endTime:   null,
    loopStart: null,
  ...
  },
  {
    ...
    title:     'Нужна',
    artist:    'MDee',
    file:      'music/MDee - нужна (pesni.fm).mp3',
    cover:     'js/jpg/Abirok3.jpeg',
    startTime: 0,
    endTime:   null,
    loopStart: null,
    volume:    0.75,
...
const AudioEngine = (() => {
  ...
  function stopSource() {
    ...
    if (currentSource) {
      try { currentSource.onended = null; currentSource.disconnect(); currentSource.stop(); } catch(e) {}
      currentSource = null;
    }
  }
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Попытка автозапуска: некоторые браузеры блокируют её без взаимодействия.
  try { await AudioEngine.unlock(); } catch (e) {}
  // Если спустя короткое время трек не запущен, показать подсказку тапнуть для воспроизведения
  setTimeout(() => {
    const s = AudioEngine.getState ? AudioEngine.getState() : null;
    if (!s || !s.isPlaying) UI.showFallback();
  }, 700);
});
